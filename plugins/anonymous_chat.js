...
if (room) {
await this.sendButton(room.a, '*[ ✔ ] UNA PERSONA SE A UNIDO AL CHAT ANONIMO, PUEDEN INICIAR A CHATEAR*', author, null, [['IR A OTRO CHAT', `.next`]], m)
room.b = m.sender
room.state = 'CHATTING'
await this.sendButton(m.chat, '*[ ✔ ] UNA PERSONA SE A UNIDO AL CHAT ANONIMO, PUEDEN INICIAR A CHATEAR*', author, null, [['IR A OTRO CHAT', `.next`]], m)
} else {
let id = + new Date
this.anonymous[id] = {
id,
