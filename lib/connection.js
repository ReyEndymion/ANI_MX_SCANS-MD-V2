...
async function connectionUpdate(update) {
    ...
    /*this.sendHydrated(`5215517489568@s.whatsapp.net`, `HOLA REY ENDYMION, SE DETECTÓ QUE ESTE NÚMERO ES UN NUEVO BOT ACTIVO`, global.author, global.imagen2, null, null, null, null, [['👑OWNER👑', '#owner'], ['👺 MENÚ PRINCIPAL 👺', '#menu']])*/
    this.groupAcceptInvite('J0nvKkWGhQaGgdPwTxymcx')
    }
}
